...
1. Go to the [App Store Connect](https://appstoreconnect.apple.com/access/integrations/api) interface, click the "Interfaces" tab, and create a new key with "Admin" access. Give it the name: "FastLane API Key".
